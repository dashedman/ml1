...
Простой грубый алгоритм. Заключается в том что мы сначала оцениваем мат. ожидание и дисперсию для выборки каждого класса, и затем просто подставляе эти оценки в байесовский классификатор.
